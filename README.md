...
- 示例输出：[examples/sample-output-lingxi-notes.md](examples/sample-output-lingxi-notes.md)
- AirPods Pro 协议示例：
  - [examples/airpods-pro-user-agreement.md](examples/airpods-pro-user-agreement.md)
  - [examples/airpods-pro-privacy-policy.md](examples/airpods-pro-privacy-policy.md)
